...
<head>
    ...
    <title>${title!'Full stack road-login'}</title>
...
<div class="container">
<#if msg??>
<#-- s Prompt message (user name or password error） -->
...
<#-- e Prompt message (user name or password error） -->
    <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
                ...
                <div class="form-group">
                    <div class="form-check">
                        <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="rememberme"> Remember the password.</label>
                    </div>
                </div>
            ...
            <div class="container text-center mt-3">
                <div class="row">
                    <a class="d-block small col-sm offset-6" href="userregister">REGISTER Now</a>
                    <a class="d-block small col-sm" href="#">Forgot your password?</a>
                </div>
            </div>
        </div>
    </div>
