...
<head>
    ...
    <title>${title!'The road to full stack - a personal blog of the Prince of Swing yard'}</title>
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active"
                ...
                <div class="carousel-caption d-none d-md-block">
                    <h3 class="txt_shadow">Good judgment comes from experience, but experience comes from wrong judgment</h3>
            ...
            <div class="carousel-item"
                ...
                <div class="carousel-caption d-none d-md-block">
                    <h3 class="txt_shadow">I am not a great programmer, I am just a good programmer with good habits</h3>
            ...
            <div class="carousel-item"
                ...
                <div class="carousel-caption d-none d-md-block">
                    <h3 class="txt_shadow">Most of you are familiar with the programmer's virtues, and there are three: laziness</h3>
...
<section class="py-5">
    <div class="container container-fluid">
        <h1>The road to the full stack -- the prince's personal blog</h1>
    </div>
</section>
